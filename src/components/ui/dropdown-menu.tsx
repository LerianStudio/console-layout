...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        'focus:bg-accent focus:bg-shadcn-100 data-[state=open]:bg-accent flex cursor-default items-center gap-3 px-3 py-2 text-sm font-medium text-[#52525b] outline-hidden select-none',
        className
      )}
      {...props}
    >
